    ...
    <div class="container">
        <div class="card">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                <h2 style="color:#00008b">🔒 Admin Login</h2>
                <hr style="height:2px;border-width:0;color:#00008b;background-color:#00008b"><br>
                <label for="username" style="text-align: left; color:#00008b;">Username:</label>
                <input type="text" name="username" placeholder="username" required class="raja">
                <label for="password" style=" text-align: left; color:#00008b;">Password:</label>
